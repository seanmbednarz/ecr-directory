...
export const PEOPLE: Person[] = [
  ...
  { id: 'leah-leggett', name: 'Leah Leggett', cred: '', title: 'Reception & Office Coordinator', dept: 'operations', parent: 'jennifer-schwartz',
    email: 'lleggett@ecrtx.com', phone: '512-505-0945', mobile: '', linkedin: LI('leah-leggett-bb9228375'),
  ...
  { id: 'gage-berne', name: 'Gage Berne', cred: '', title: 'Research Analyst', dept: 'operations', parent: 'jennifer-schwartz',
    email: 'gberne@ecrtx.com', phone: '512-505-2755', mobile: '210-416-6691', linkedin: LI('gage-berne'),
    photo: '/Gage_Berne_-_Square.jpg', bio: BIO('gage-berne') },
  ...
  { id: 'lee-jordan', name: 'Lee Jordan', cred: '', title: 'Building Engineer', dept: 'management', parent: 'mike-bartz',
    ...
    photo: '/Lee_Jordan_-_Square.jpg', bio: BIO('lee-jordan') },
  { id: 'bradley-augustin', name: 'Bradley Augustin', cred: '', title: 'Maintenance Technician', dept: 'management', parent: 'mike-bartz',
    ...
    photo: '/Bradley_Augustin_-_Square.jpg', bio: BIO('bradley-augustin') },
  ...
  { id: 'brandon-meadows', name: 'Brandon Meadows', cred: '', title: 'Building Engineer', dept: 'management', parent: 'mike-bartz',
    ...
    photo: '/Brandon_Meadows_-_Square.jpg', bio: BIO('brandon-meadows') },
  ...
  { id: 'chris-standard', name: 'Chris Standard', cred: '', title: 'Property Manager', dept: 'management', parent: 'franziska-jackson',
    ...
    photo: '/Chris_Standard_-_Square.jpg', bio: BIO('chris-standard') },
  ...
  { id: 'matthew-brimble', name: 'Matthew Brimble', cred: '', title: 'Property Accountant', dept: 'management', parent: 'stephanie-trevino',
    ...
    photo: '/Matthew_Brimble_-_Square.jpg', bio: BIO('matthew-brimble') },
